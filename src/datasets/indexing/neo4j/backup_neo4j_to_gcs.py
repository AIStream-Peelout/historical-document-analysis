...
Usage
-----
python backup_neo4j_to_gcs.py                   # backup current NEO4J_DATABASE
python backup_neo4j_to_gcs.py --dry-run         # export locally, skip GCS upload
python backup_neo4j_to_gcs.py --out-dir /tmp    # write archive to a custom local dir
