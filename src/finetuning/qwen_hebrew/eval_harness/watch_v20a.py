"""Watch the resumed v20a Colab run via its hub checkpoint pushes.
...
REPO_ID = "isaacmg/qwen3-vl-8b-hebrew-v20a-ckpt"
POLL_S = 900
STALE_H = 3.2
...
last_step = 600            # resume point; evals through 600 already reported
last_new_time = time.time()
stale_alerted = False
min_eval = 0.7225          # best seen through step 600 (step 500)
